    ...
    >
      ...
      >
          ...
          <AnimatePresence>
            {dragging ? (
              <motion.div
                ...
                className="relative rounded-xl bg-foreground px-2.5 py-1 text-sm font-medium text-background tabular-nums shadow-md"
              >
                {readout}
        ...
        <button
          type="button"
          {...sliderProps}
          className="absolute inset-x-0 -inset-y-5 touch-none rounded-full ring-foreground/30 outline-none focus-visible:ring-2"
        />
      </div>
    </div>
  );
