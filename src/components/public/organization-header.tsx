...
export function OrganizationHeader({ organization }: { organization: Organization }) {
  return (
    <header className="bg-brand text-brand-foreground">
      <div className="mx-auto flex w-full max-w-2xl items-center gap-4 px-4 py-4 sm:px-6">
        ...
        <div className="min-w-0">
          <p className="truncate text-lg font-bold leading-tight">{organization.platformName}</p>
