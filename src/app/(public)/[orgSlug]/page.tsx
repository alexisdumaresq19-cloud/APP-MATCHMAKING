    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-base text-muted-foreground">
          Inscrivez votre entreprise en quelques minutes : nous vous jumelons avec des entreprises
          complémentaires à la vôtre, et vous connaissez votre table avant d&apos;arriver.
        </p>
      </div>
                  ...
                  {spotsLeft !== null && availability.open ? (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <dd>
                          {spotsLeft === 1 ? "Il reste 1 place" : `Il reste ${spotsLeft} places`}
                        </dd>
                      </div>
                    </div>
                  ) : null}
      ...
      <p className="text-sm text-muted-foreground">
        Déjà inscrit à un événement? Utilisez le lien personnel reçu par courriel pour retrouver vos
        jumelages, votre table et les autres événements ouverts.
      </p>
    </div>
  );
}
